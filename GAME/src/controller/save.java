...
public class save {
    ...
    public void save(Memento snapshot) {
        ...
        try {
            ...
            // ObjectOutputStream out2 = new ObjectOutputStream(fileOut2);
            out1.writeObject(r.create(array.getShapeArray(snapshot.getShapes())));// we
                                                                                  // designate
                                                                                  // our
                                                                                  // array
                                                                                  // of
    ...
    public Object load2() {
        try// If this doesnt work throw an exception
        {
            FileInputStream fileIn6 = new FileInputStream("car6");// Read serial
                                                                  // file.
            FileInputStream fileIn7 = new FileInputStream("car7");
